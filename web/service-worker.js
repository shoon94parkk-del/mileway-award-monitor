...
self.addEventListener('fetch',event=>{
 ...
 if(event.request.method!=='GET'||url.hostname==='raw.githubusercontent.com'||url.hostname==='mileway-alert-api.onrender.com'||url.pathname.endsWith('/snapshot.json')||url.pathname.endsWith('/health.json')||url.pathname.endsWith('/changes.json'))return;
